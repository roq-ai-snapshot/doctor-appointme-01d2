  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Doctor Appointment System, your one-stop platform for easy and efficient scheduling of medical consultations. Simplifying healthcare, one appointment at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Doctor Appointment System, your one-stop platform for easy and efficient scheduling of medical consultations. Simplifying healthcare, one appointment at a time.`}
            </Text>
            <Box
